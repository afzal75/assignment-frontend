  ...
  const UpcomingService = [
    {
      ...
      image: "https://i.ibb.co/jf16PRr/img.jpg",
    },
    {
      id: 2,
      title: "Expert Car Service You Can Trust.",
      ...
      descripttion:
        "Welcome to PACK & SHIFT Removal group, Professional House Shifting Service to anywhere in Bangladesh from Dhaka City. AlsoInternational movers and packers Any country of the world",
      image: "https://i.ibb.co/7n9zjv1/img2.jpg",
    },
    {
      id: 3,
      title: "Expert Car Service You Can Trust.",
      ...
      descripttion:
        "Welcome to PACK & SHIFT Removal group, Professional House Shifting Service to anywhere in Bangladesh from Dhaka City. AlsoInternational movers and packers Any country of the world",
      image: "https://i.ibb.co/x3R2MmH/img3.jpg",
    },
    {
      id: 4,
      title: "Expert Car Service You Can Trust.",
      ...
      descripttion:
        "Welcome to PACK & SHIFT Removal group, Professional House Shifting Service to anywhere in Bangladesh from Dhaka City. AlsoInternational movers and packers Any country of the world",
      image: "https://i.ibb.co/b5WDDVS/img4.jpg",
    },
    {
      id: 5,
      title: "Expert Car Service You Can Trust.",
      ...
      descripttion:
        "Welcome to PACK & SHIFT Removal group, Professional House Shifting Service to anywhere in Bangladesh from Dhaka City. AlsoInternational movers and packers Any country of the world",
      image: "https://i.ibb.co/WnSdH7F/img5.jpg",
    },
    {
      id: 6,
      title: "Expert Car Service You Can Trust.",
      ...
      descripttion:
        "Welcome to PACK & SHIFT Removal group, Professional House Shifting Service to anywhere in Bangladesh from Dhaka City. AlsoInternational movers and packers Any country of the world",
      image: "https://i.ibb.co/x2YXmMP/img6.jpg",
    },
  ];
