      ...
      <footer className="footer p-10 text-white mt-16 bg-slate-700">
        <nav>
          ...
          <div className="flex gap-2 justify-center">
            ...
            <p className="link link-hover">Lalmai Cumilla</p>
          </div>
          <div className="flex gap-2 justify-center">
            <BiPhoneCall className="text-xl" />
            <p className="link link-hover">+88 01648022498</p>
          </div>
          <div className="flex gap-2 justify-center">
            <AiOutlineMail className="text-xl" />
            <p className="link link-hover">afzalbhuiyan16@gmail.com</p>
          </div>
        </nav>
        <nav>
          <h1 className="text-xl  text-center">Services</h1>
          <p className="link link-hover">Car Wash Services</p>
          <p className="link link-hover">Oil Change</p>
          <p className="link link-hover">Full Car Repairing</p>
          <p className="link link-hover">Car Mechanic</p>
        </nav>
        <nav>
